  ...
  <div class="xtx-cart-page">
    <div class="container m-top-20">
        ...
        <table>
          ...
          <tbody>
            <tr v-for="i in cartStore().cartList" :key="i.id">
              <td>
                <el-checkbox :model-value="i.selected" @change="cartStore().singleCheck(i.skuId, $event)" />
              </td>
              <td>
                <div class="goods">
                  <RouterLink :to="`//${i.goodsId}`"><img :src="'http://localhost:8081/img/'+i.img" alt="" /></RouterLink>
                  <div>
      ...
      <div class="action">
        ...
        <div class="total">
          <el-button size="large" type="primary" @click="cartStore().cartList.length && $router.replace('/home/checkout')">下单结算</el-button>
        </div>
      </div>
    </div>
  </div>
